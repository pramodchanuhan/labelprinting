        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- You can use $data->... to access form data here -->
              ...
              <form method="POST" action="{{ route('form-store') }}">
                ...
                <table class="hr-comments-table">
                  ...
                  <tr>
                    <td><input type="text" id="reference" name="emp_reference[]" value="{{ $key }}"></td>
                    <td><input type="text" id="reference" name="emp_reference_no[]" value="{{ $value }}"></td>
                  </tr>
                  @endforeach
                  {{-- <tr>
                ...
                <div class="strengths-weaknesses-container">
                  <table class="hr-comments-table">
                    ...
                    <tr>
                      ...
                      <td><textarea id="ops_strengths" name="ops_strengths" rows="5" required></textarea></td>
                      <td><textarea id="ops_weaknesses" name="ops_weaknesses" rows="5" required></textarea></td>
                    </tr>

                    <tr>
                      <input type="hidden" name="iaf_id" id="iaf_id" value="{{ $Assesment_form->id }}">
                      <td><textarea id="ops_name" name="ops_name" rows="1">Name : </textarea></td>
                      <td>Date :<input type="date" id="ops_date" name="ops_date" required style="border:none;padding-left:10px;"></td>
                    </tr>
                  </table>
                </div><br>
                ...
                <div class="strengths-weaknesses-container">
                  ...
                  <table class="hr-comments-table">
                    ...
                    <tr>
                      ...
                      <td><textarea id="mock_strengths" name="mock_strengths" rows="5" required></textarea></td>
                      <td><textarea id="mock_weaknesses" name="mock_weaknesses" rows="5" required></textarea></td>
                    </tr>

                    <tr>
                      <td><textarea id="mock_name" name="mock_name" rows="1">Name : </textarea></td>
                      <td>Date :<input type="date" id="mock_date" name="mock_date" required style="border:none;padding-left:10px;"></td>
                    </tr>
                  </table>
                </div>
