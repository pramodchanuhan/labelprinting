                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="{{ url('') }}client-profile">Barry Cuda
                                                        <span>CEO</span></a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar"><img alt=""
                                                            src="{{ asset('') }}assets/img/profiles/avatar-19.jpg"></a>
                                                    <a href="{{ url('') }}client-profile">Tressa Wexler
                                                        <span>Manager</span></a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="{{ url('') }}client-profile">Ruby Bartlett
                                                        <span>CEO</span></a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="{{ url('') }}client-profile"> Misty Tison
                                                        <span>CEO</span></a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="{{ url('') }}client-profile"> Daniel Deacon
                                                        <span>CEO</span></a>
                                                </h2>
                                            </td>
                            ...
                            <div class="table-responsive">
                                <table class="table custom-table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h2><a href="{{ url('') }}project-view">Office Management</a>
                                                </h2>
                                        ...
                                        <tr>
                                            <td>
                                                <h2><a href="{{ url('') }}project-view">Project Management</a>
                                                </h2>
                                                <small class="block text-ellipsis">
                                            ...
                                            <td>
                                                <div class="progress progress-xs progress-striped">
                                                    <div class="progress-bar" role="progressbar"
                                                        data-toggle="tooltip" title="15%" style="width: 15%">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <h2><a href="{{ url('') }}project-view">Video Calling App</a>
                                                </h2>
                                                <small class="block text-ellipsis">
                                            ...
                                            <td>
                                                <div class="progress progress-xs progress-striped">
                                                    <div class="progress-bar" role="progressbar"
                                                        data-toggle="tooltip" title="49%" style="width: 49%">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <h2><a href="{{ url('') }}project-view">Hospital
                                                        Administration</a></h2>
                                                <small class="block text-ellipsis">
                                            ...
                                            <td>
                                                <div class="progress progress-xs progress-striped">
                                                    <div class="progress-bar" role="progressbar"
                                                        data-toggle="tooltip" title="88%" style="width: 88%">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td>
                                                <h2><a href="{{ url('') }}project-view">Digital Marketplace</a>
                                                </h2>
                                                <small class="block text-ellipsis">
